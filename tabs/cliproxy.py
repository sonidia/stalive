...
import csv, json, os, socket, subprocess, sys, threading, time, uuid, requests

from PySide6.QtCore import QPoint, QRect, QStringListModel, Qt, QThread, QTimer, Signal, QObject
...
from stats import StatsModal, stats_collector
...
class CliProxyTabMixin:
    ...
    def _build_cliproxy_tab(self, make_tab_icon):
        ...
        self._top_bar.tab_changed.connect(self._tabs.setCurrentIndex)
        self._tabs.currentChanged.connect(self._top_bar.set_current_index)
        self._main_layout.addWidget(self._tabs, 1)

        self._cliproxy_tab = QWidget()
        self._cliproxy_tab.setObjectName("cliproxyTab")
        self._add_main_tab(self._cliproxy_tab, make_tab_icon("cliproxy"), "CliProxy")
